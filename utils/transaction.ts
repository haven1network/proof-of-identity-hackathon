...
/**
 * Get the timestamp of a transaction from a transaction receipt.
 * Will return 0 if the timestamp was not found.
 *
 * @async
...
/**
 * Get the timestamp of a transaction from a transaction response.
 * Will return 0 if the timestamp was not found.
 *
 * @async
